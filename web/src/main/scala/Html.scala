...
enum Namespace(val uri: String):
  case HTML extends Namespace("http://www.w3.org/1999/xhtml")
...
object Html:
  ...
  final case class PostProcessing[+A](html: Html[A], effect: Node => Node) extends Html[A]:
